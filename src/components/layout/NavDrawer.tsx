...
import { mdiCardsOutline, mdiDiceMultiple, mdiFerrisWheel, mdiNumeric, mdiSwordCross } from "@mdi/js";
import Icon from "@mdi/react";

import useTexts from "../../languages";

export type SectionId = "wheel" | "versus" | "dice" | "cards" | "number";

type NavSection = {
  id: SectionId;
  icon: string;
  labelKey: "wheelTitle" | "sectionVersus" | "sectionDice" | "sectionCards" | "sectionNumber";
  available: boolean;
};
